...
import { fadeUpVariants, staggerContainerVariants, fadeRightVariants } from '../../utils/constants'
...
const stats = [
  ...
  { value: '5+', label: 'devs mentorados', icon: '👥' },
          ...
          >
            <motion.div variants={fadeUpVariants} className="mb-8 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-mono text-sm text-accent">@enriquebds</p>
              </div>
            </motion.div>

            <motion.p variants={fadeUpVariants} className="font-body text-[var(--muted)] leading-relaxed text-base mb-4">
              Sou um desenvolvedor front-end com <strong className="text-[var(--text)]">mais de 3 anos de experiência</strong> construindo interfaces rápidas, acessíveis e escaláveis. Atuo principalmente no ecossistema React + TypeScript, com foco em soluções <strong className="text-[var(--text)]">B2B SaaS</strong>, AIoT e smart cities.
            </motion.p>
            <motion.p variants={fadeUpVariants} className="font-body text-[var(--muted)] leading-relaxed text-base mb-4">
              Na Group Link One, contribuo para o desenvolvimento de plataformas de monitoramento em tempo real para cidades inteligentes, integrando dispositivos IoT com dashboards modernos e mapas interativos.
            </motion.p>
            <motion.p variants={fadeUpVariants} className="font-body text-[var(--muted)] leading-relaxed text-base mb-8">
              Além do código, gosto de compartilhar conhecimento, participar de code reviews cuidadosos e criar uma cultura de qualidade no time. Acredito que bom software começa com boa comunicação.
            </motion.p>
